/**
 * Ejemplo de caracteristicas fundamentales en Kotlin
 */
fun main(args: Array<String>) {
    // Los números se manejan como datos primitivos en Kotlin
    // Operacion artimeticas
    1 + 2
    1 - 3
    2 / 5 // División entera, si ambas partes son enteras el resultado es entero, en este caso: 0
    2.0 / 5 // División, si alguna de los operadores es Double el resultado sera Double, en este caso: 0.4
    // A pesar que los números son tratados como datos primitivos
    // estos se pueden ejecutar funciones como si se tratara de objetos
    2.times(3) // Multiplicación
    3.5.plus(4) // Suma
    // Los valores numericos pueden ser escritos de las siguientes formas
    1000000 // Un millon
    ...
    var v1 = 5 // Declaración de variable sin tipo, si la variable sera de solo lectura es mejor cambiar a val
    println(v1) // mostrar el valor 5
    var v2 = v1.toDouble() // Entra las funciones que tiene los numeros estan la funcion "to" que sirven para convertir en tipos diferentes
